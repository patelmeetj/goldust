...
if ($_SERVER["REQUEST_METHOD"] == "POST" && $response_keys["success"]) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        // Data from the form
        $name = isset($_POST['txtName']) ? trim($_POST['txtName']) : 'N/A';
        $email = isset($_POST['txtEmail']) ? trim($_POST['txtEmail']) : 'N/A';
        $contactNumber = isset($_POST['txtcontact']) ? trim($_POST['txtcontact']) : 'N/A';
        ...
        try {
            ...
            $mail->SMTPAuth = true;
            $mail->Username = 'barodaweb.inquiry@gmail.com'; // Use your SMTP username
            $mail->Password = 'rjdh ngzl urbr fmgm'; // Use your SMTP password or App Password
            $mail->SMTPSecure = 'tls';
            $mail->Port = 587;
...
<tr>
<td colspan="2">
<h3>Brochure Inquiry Details of ' . $name . '</h3>
</td>
...
<tr>
<td colspan="3">
<h3>"Brochure Download Enquiry"</h3>
</td>
</tr>
